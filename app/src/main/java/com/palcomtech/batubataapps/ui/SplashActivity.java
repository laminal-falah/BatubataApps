package com.palcomtech.batubataapps.ui;
...
import com.palcomtech.batubataapps.service.ServiceApp;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private final ServiceApp serviceApp = new ServiceApp(this);
            ...
            if (deniedCount == 0) {
                ...
                for (Map.Entry<String, Integer> entry : permissionResults.entrySet()) {
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this, permName)) {
                        showDialog(getString(R.string.title_permission), msg[0], pos[0], new DialogInterface.OnClickListener() {
                                    @Override
                                ...
                                getString(R.string.negative_permission), new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.dismiss();
                                        finish();
                        ...
                        showDialog(getString(R.string.title_permission), msg[1], pos[1], new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.dismiss();

...
public class DialogFilterBahanMentah extends DialogFragment {

    public static final String TAG = DialogFilterBahanMentah.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.dialog_filter_bahan_mentah, container, false);
    ...
    public FiltersBahanMentah getFilters() {
        FiltersBahanMentah filters = new FiltersBahanMentah();
    ...
    interface FilterListener {
        void onFilter(FiltersBahanMentah filtersBahanMentah);
    }
}

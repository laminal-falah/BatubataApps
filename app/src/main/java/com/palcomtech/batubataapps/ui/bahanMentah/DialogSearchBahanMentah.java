...
public class DialogSearchBahanMentah extends DialogFragment {
    public static final String TAG = DialogSearchBahanMentah.class.getSimpleName();
    ...
    public interface SearchListener {
        ...
        void onResetSearchListener(FiltersBahanMentah filtersBahanMentah);
    }
}
